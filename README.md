# IBM Cloud Pak TrustStore GitOps module

Module to populate a gitops repo with the resources required to provision IBM TrustStore in a cluster.
...
- CP Catalogs - github.com/cloud-native-toolkit/terraform-gitops-cp-catalogs.git

## Example usage

```hcl-terraform
module "truststore" {
   source = "github.com/cloud-native-toolkit/terraform-gitops-cp-truststore"
